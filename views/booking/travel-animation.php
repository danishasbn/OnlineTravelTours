<?php
    ...
    if(isset($_GET['carRentalID']) && isset($_GET['option1'])){
        $id = $_GET['carRentalID'];
        echo "<meta http-equiv='refresh' content='3;url=$internetBanking?carRentalID=$id'>";
    }
    if(isset($_GET['carRentalID']) && isset($_GET['option2'])){
        $id = $_GET['carRentalID'];
        echo "<meta http-equiv='refresh' content='3;url=$payAtShowroom?carRentalID=$id'>";
    }

    // Hotel
    if(isset($_GET['hotelID']) && isset($_GET['option1'])){
        $id = $_GET['hotelID'];
        echo "<meta http-equiv='refresh' content='3;url=$internetBanking?hotelID=$id'>";
    }
    if(isset($_GET['hotelID']) && isset($_GET['option2'])){
        $id = $_GET['hotelID'];
        echo "<meta http-equiv='refresh' content='3;url=$payAtShowroom?hotelID=$id'>";
    }
...
<head>
    ...
    <style>
   .animation-wrapper{
        height:500px; width:500px; margin:0 auto; position: absolute;
        top: 50%;
        left: 50%;
...
body {
  background: -webkit-radial-gradient(center, ellipse cover, #fff 0%, #69C8C3 100%);
}
...
#airplane2, #airplane1 {
  ...
  -webkit-transform: translate3d(0, 0, 0);
  -webkit-animation: rotate-right 3s linear 0s infinite;
}
    ...
    <g id="Timeless_Design">
        ...
        <g>
            <g>
                ...
                <text transform="matrix(0.977 -0.2134 0 1 149.3367 226.363)"  font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">T</text>
                <text transform="matrix(0.977 -0.2133 0 1 161.5945 223.6863)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">R</text>
                <text transform="matrix(0.977 -0.2133 0 1 175.5847 220.6306)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">A</text>
                <text transform="matrix(0.977 -0.2133 0 1 190.0623 217.4695)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">V</text>
                <text transform="matrix(0.977 -0.2133 0 1 203.6252 214.5085)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">E</text>
                <text transform="matrix(0.977 -0.2133 0 1 215.5266 211.9099)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">L</text>
                <text transform="matrix(0.977 -0.2133 0 1 226.9495 209.4148)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">E</text>
                <text transform="matrix(0.977 -0.2133 0 1 238.844 206.8171)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="20.6581">R</text>
            </g>
            <g>
                <line fill="none" x1="146.574" y1="189.775" x2="205.712" y2="176.861"/>
                <text transform="matrix(0.977 -0.2134 0 1 151.6272 187.7834)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">B</text>
                <text transform="matrix(0.977 -0.2134 0 1 157.1804 186.5706)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">E</text>
                <text transform="matrix(0.977 -0.2134 0 1 161.8459 185.552)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">C</text>
                <text transform="matrix(0.977 -0.2134 0 1 167.1052 184.4036)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">O</text>
                <text transform="matrix(0.977 -0.2133 0 1 172.5046 183.2244)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">M</text>
                <text transform="matrix(0.977 -0.2133 0 1 179.8552 181.6189)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">E</text>
                <text transform="matrix(0.977 -0.2133 0 1 184.5198 180.6003)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12"> </text>
                <text transform="matrix(0.977 -0.2133 0 1 186.8635 180.0886)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">A</text>
            </g>
            <g>
                <line fill="none" x1="213.236" y1="234.207" x2="272.375" y2="221.292"/>
                <text transform="matrix(0.977 -0.2133 0 1 218.2815 232.2166)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12"> </text>
                <text transform="matrix(0.977 -0.2134 0 1 220.6321 231.7029)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12"> </text>
                <text transform="matrix(0.977 -0.2133 0 1 222.9778 231.1912)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">T</text>
                <text transform="matrix(0.977 -0.2134 0 1 227.7874 230.1404)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">O</text>
                <text transform="matrix(0.977 -0.2133 0 1 233.1858 228.9607)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">D</text>
                <text transform="matrix(0.977 -0.2133 0 1 238.8342 227.7273)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">A</text>
                <text transform="matrix(0.977 -0.2134 0 1 244.5217 226.4861)" font-family="'Pathway Gothic One'" fill="#69C8C3" font-size="12">Y</text>
            </g>
