        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="txt-hotelName" name="txt-hotelName"
                        data-validation="required custom" data-validation-regexp="^([a-zA-Z ]+)$"
                        value="<?= $row_hotel['hotelName'];?>">

                    <label for="txt-hotelPrice">Price (per person)*</label>
                    <input type="text" class="form-control input-width-2" id="txt-hotelPrice"
                        name="txt-hotelPrice" placeholder="Rs." data-validation="number"
                        data-validation-allowing="float" value="<?= $row_hotel['price'];?>">
                    <br>
                    ...
                    <input type="text" class="form-control availabilityDate input-width-2" id="txt-dateFrom"
                        name="txt-dateFrom" data-validation="required" value="<?= $row_hotel['dateFrom'];?>"
                        placeholder="Select Date From..">

                    <label for="txt-dateTo">Date To *</label>
                    <input type="text" class="form-control availabilityDate input-width-2" id="txt-dateTo"
                        name="txt-dateTo" data-validation="required" value="<?= $row_hotel['dateTo'];?>"
                        placeholder="Select Date To..">

                    <label for="txt-purchaseInclude">Purchase Include *</label>
                    <textarea class="form-control" rows="10" id="txt-purchaseInclude" name="txt-purchaseInclude"
                        data-validation="required"><?= $row_hotel['purchaseInclude'];?></textarea>

                    <label for="txt-PackageDetails">Package Details *</label>
                    <textarea class="form-control" rows="10" name="txt-PackageDetails" id="txt-PackageDetails"
                        data-validation="required"><?= $row_hotel['packageDetails'];?></textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control input-width-2" name="txt-discount" id="txt-discount">
                        ...
                        ?>
                        <option selected value="<?= $row_hotel['id']?>"><?= $row_hotel['discount_percent']?>
                        </option>
                        <?php
                            }
                        ?>
