...
<?php require('../../../Action/action-update-package-gallery.php'); ?>


<main class="col bg-faded py-3">
    <h3 class="text-left"> >> <?= @$packageName;?> <small> <em> Photo Gallery </em></small> <<</h3>  
    <br>
        ...
        <table id="package-gallery" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td><a href="view-package-gallery.php?id=<?= $row_gallery['id'];?>&del=<?= $row_gallery['gallery_id'] ?>"> <span data-balloon="Remove" data-balloon-pos="up"><img src="<?= $remove; ?>" class="icon" /></span></a> </td>
            </tr>
            <?php
                }
            }
