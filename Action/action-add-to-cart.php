        ...
        if($orderCategory == 'car rental'){
            ...
            if($orderCategory == 'package'){
                ...
                if($packageType == 'Hotel'){
                    ...
                    $packageType    = $_POST['package_type'];
                    $totalPrice     = $_POST['totalPriceTravel'];
                    
                    $fullName       = $_POST['txt-fullName'];
                    $mobileNumber   = $_POST['txt-mobileNumber'];
                    $departureDate  = $_POST['txt-departureDate'];
                    $returnDate     = $_POST['txt-returnDate'];
                    $paxAdult       = $_POST['sltAdult'];
                    $paxTeen        = $_POST['sltTeen'];
                    $paxChild       = $_POST['sltChild'];
                    $paxInfant      = $_POST['sltInfant'];
                    ...
                    // Insert into tbl_order package - Travel
                    $sql_insertOrder = "INSERT INTO tbl_orderpackage(package_type_id,total_price,package_id,order_category,full_name,mobile_number,departure_date,return_date,pax_adult,pax_teen,pax_child,pax_infant)
                                        VALUES('$packageTypeID','$totalPrice', '$getItemID', '$orderCategory', '$fullName' , '$mobileNumber' , '$departureDate' , '$returnDate' , '$paxAdult', '$paxTeen', '$paxChild', '$paxInfant')";
                    $qry_insertOrder = mysqli_query($dbc,$sql_insertOrder);
